...
parser.add_argument('--deploy-policy', default=None, choices=['fixed', 'exp', 'dqn-feature', 'q-value', 'dqn-feature-min','reset', 'policy'])
...
parser.add_argument('--switch-memory-capcacity', default=1e6, type=int)
